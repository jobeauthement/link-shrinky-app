    ...
    <section class="w-full px-3 antialiased bg-indigo-600 lg:px-6 h-screen" data-primary="indigo-600"
        ...
        <div class="mx-auto max-w-7xl">
            <nav class="flex items-center w-full h-24 select-none" x-data="{ showMenu: false }">
                <div
                    ...
                    <a href="/" class="w-1/4 py-4 pl-6 pr-4 md:pl-4 md:py-0">
                        <span class="p-1 text-xl font-black leading-none text-white select-none"><span
                                class="">Linky</span><span class="text-indigo-300"
                                data-primary="indigo-300">.</span></span>
                    </a>
                    <div class="fixed top-0 left-0 z-40 items-center w-full h-full p-3 text-xl bg-gray-900 bg-opacity-50 md:text-sm lg:text-base md:w-3/4 md:bg-transparent md:p-0 md:relative md:flex hidden"
            ...
            <div class="container py-32 mx-auto text-center sm:px-4">
                ...
                <form form method="POST" action="/" data-rounded="rounded-full"
                    class="relative flex flex-col items-center max-w-md mx-auto mt-12 overflow-hidden text-center">
                    @csrf
                    <div class="text-sm mb-10 text-indigo-300">
